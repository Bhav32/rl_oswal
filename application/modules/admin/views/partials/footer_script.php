...
<script src="<?= base_url('assets/admin/js/matrix.chat.js'); ?>"></script> 
<script src="<?= base_url('assets/admin/js/jquery.validate.js'); ?>"></script> 
<script src="<?= base_url('assets/admin/js/matrix.form_validation.js'); ?>"></script> 
...
<script src="<?= base_url('assets/admin/js/matrix.popover.js'); ?>"></script> 
